<template>
  <div class="sms-analysis-container">
    <!-- 搜索表单 -->
    ...
    <div class="table-section">
      ...
      >
        ...
        <el-table-column label="发送号码数" prop="uniquePhoneCount" width="300" align="center">
          <template #default="scope">
            <span class="count-text">{{ scope.row.uniquePhoneCount || 0 }}</span>
          </template>
        </el-table-column>
        <el-table-column label="总记录数" prop="totalRecords" width="300" align="center">
          <template #default="scope">
...
<script setup name="SmsAnalysis106">
import { ref, onMounted, computed } from 'vue'
import { getUserSms106StatisticsTree } from '@/api/system/Sms106Record'
...
function getList() {
  ...
  getUserSms106StatisticsTree(params).then(response => {
...
// 侧边栏收起时调整布局
:deep(.hideSidebar) ~ .main-container .sms-analysis-container {
  left: 54px;
}
